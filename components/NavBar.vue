<template>
  <nav class="flex justify-between p-2 bg-maroon">
    <NuxtLink to="/" class="relative m-auto p-auto">
      <img src="../Images/Dark.png" class="h-14 relative m-auto p-auto" alt="Logo Image">
    </NuxtLink>
